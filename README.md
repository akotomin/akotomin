...
### Обо мне:
Я продуктовый аналитик. Выявляю точки роста, трансформирую данные в понятные инсайты и внедряю решения, которые влияют на ключевые метрики.
Умею не только добывать инсайты, но и доносить их до команд и руководства — ясно, структурированно и с фокусом на actionable insights.

- 👨‍🎓 Для повышения компетенции в анализе данных прошел несколько онлайн курсов, с помощью которых освоил [![Python Badge](https://img.shields.io/badge/Python-3776AB?logo=Python&style=flat&logoColor=white)](https://github.com/akotomin/Python), SQL, математическую статистику, теорию вероятности, продуктовые метрики и фреймворки для развития продукта. В рамках работы использовал такие BI 
...
- 🎤 Стараюсь работать также и над методами донесения информации длябизнеса, поэтому я прошел курс ораторского мастерства и продолжаю улучшать свои выступления и презентации.
